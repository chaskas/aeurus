...
use Aeurus\AdminBundle\Entity\Tag;
use Aeurus\AdminBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AeurusAdminBundle:Tag')->findAll();
     ...
     * @Method("POST")
     * @Template("AeurusAdminBundle:Tag:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_tag_edit', array('id' => $entity->getId())));
        }
    ...
    public function editAction($id)
    {
        ...
        $entity = $em->getRepository('AeurusAdminBundle:Tag')->find($id);
     ...
     * @Method("PUT")
     * @Template("AeurusAdminBundle:Tag:edit.html.twig")
     */
